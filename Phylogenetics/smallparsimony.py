...
def getparsimonyscore(T, root, score):
    ...
    '''
    1) if left and right child are -1 then return score
    else
    2) get Hamming distance between root and left child, and
    between root and right child, and add it to the score
